...
function tt_timetable($atts, $content)
{
	...
	{
		$output .= '<div class="row"><div class="col-md-6"><ul class="timetable_clearfix tabs_box_navigation' . ((int)$responsive ? " tt_responsive" : "") . ' sf-timetable-menu' . ($id!="" ? ' ' . $id : '') . '">
		...
		</ul></div><div class="col-md-6"><div class="print_schedule"><a href="http://bhamjcc.com/new/wp-content/uploads/2014/12/Print-Schedule.pdf" target="_blank">PRINT SCHEDULE</a></div></div></div>';
	}
