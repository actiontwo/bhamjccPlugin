	...
	?>
			...
			<div class="codenegar_ajax_search_wrapper">
                            <form id="codenegar_ajax_search_form" data-full_search_url="<?php echo $codenegar_aas->options->full_search_url; ?>" action="<?php echo esc_url(home_url('/')); ?>" method="get">
                                    <input name="search" id="search" class="ajax_autosuggest_input sb-search-input" type="text"  value="<?php echo $value; ?>" placeholder="<?php echo $placeholder; ?>"/>
                                    <input class="ajax_autosuggest_submit sb-search-submit" type="submit" value="">
